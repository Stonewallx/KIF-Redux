@echo off
title PIF Spritepack Installer/Updater
color 0A

echo ============================================================
echo              PIF SPRITEPACK INSTALLER / UPDATER
echo ============================================================
echo:
...
%mgit% remote add origin "https://github.com/Stonewallx/PIF-Spritepack.git"
echo       Connected to: github.com/Stonewallx/PIF-Spritepack
echo:
...
color 0B
echo:
echo   SUCCESS! PIF Spritepack has been installed/updated!
echo:
